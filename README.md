...
Anti-Theft [Computrace](https://www.wikiwand.com/en/LoJack_for_Laptops) |  :o:                 | Easy Backdoor? | Laptop tracking software with features including the abilities to remotely lock, delete files from, and locate the _stolen_ laptop on a map | [:spades:](https://securelist.com/absolute-computrace-revisited/58278/)               
