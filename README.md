...
[Fingerprint](https://github.com/dh4rm4/A-Reasonably-Secure-Thinkpad/blob/master/src/img/fingerprint.png?raw=true) | [Predesktop Authentification]() | :x: | Windows Only | | [:spades:](https://www.avg.com/en/signal/3-reasons-to-never-use-fingerprint-locks) [:spades:](https://www.csoonline.com/article/2223077/microsoft-subnet/laptop-fingerprint-reader-destroys--entire-security-model-of-windows-accounts-.html)
